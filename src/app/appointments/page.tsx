    ...
    <div className="min-h-screen bg-gradient-to-r from-teal-900 via-slate-900 to-teal-900">
      ...
      <header className="relative z-10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="text-white text-2xl font-bold hover:text-green-400 transition-colors">DataSolace</Link>
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/appointments" className="text-green-400 font-semibold">Appointments</Link>
          </nav>
