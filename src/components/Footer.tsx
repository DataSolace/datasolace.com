...
export default function Footer() {
  return (
    <footer className="bg-[var(--brand-blue)] border-t border-[var(--brand-green)] py-8 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          {/* Left side - Company name and copyright */}
          <div className="text-center md:text-left">
            <Link href="/" className="text-white text-xl font-bold hover:text-[var(--brand-teal)] transition-colors">
              DataSolace Ltd
            </Link>
            <p className="text-[var(--brand-white)] text-sm mt-1">
              © {new Date().getFullYear()} DataSolace Ltd. All rights reserved.
            </p>
          </div>
          ...
          <div className="text-center md:text-right">
            <Link 
              href="/privacy-policy" 
              className="text-[var(--brand-white)] hover:text-[var(--brand-teal)] transition-colors text-sm"
            >
              Privacy Policy
            </Link>
          </div>
